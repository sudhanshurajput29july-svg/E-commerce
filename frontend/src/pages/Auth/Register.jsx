...
import { ShoppingBag, KeyRound, Mail, User, ArrowRight, Eye, EyeOff } from 'lucide-react';
      ...
      <div className="max-w-md w-full space-y-8 bg-white p-8 rounded-3xl border border-slate-200 shadow-sm dark:bg-slate-800 dark:border-slate-700">
        ...
        <div className="text-center">
          ...
          <p className="mt-2 text-xs text-slate-500 dark:text-slate-400">
            ...
            <Link to={`/login?redirect=${encodeURIComponent(redirect)}`} className="font-semibold text-indigo-600 hover:text-indigo-500 dark:text-indigo-400">
              Sign in
            </Link>
          </p>
        </div>
        ...
        <form className="mt-8 space-y-4" onSubmit={handleSubmit}>
          <div>
            <label className="block text-2xs font-semibold text-slate-500 uppercase mb-1 dark:text-slate-400">Full Name</label>
          ...
          <div>
            <label className="block text-2xs font-semibold text-slate-500 uppercase mb-1 dark:text-slate-400">Password</label>
            <div className="relative">
              <input
          ...
          <div>
            <label className="block text-2xs font-semibold text-slate-500 uppercase mb-1 dark:text-slate-400">Confirm Password</label>
            <div className="relative">
              <input
          ...
          >
            {loading ? 'Creating Account...' : 'Sign Up'} <ArrowRight className="h-3.5 w-3.5 ml-2" />
          </button>
        </form>
      </div>
    </div>
